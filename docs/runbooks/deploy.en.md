# Runbook — sdkwork-discovery deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-discovery-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-discovery/bundle`, loads the image, starts
